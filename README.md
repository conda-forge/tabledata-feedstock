...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tabledata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10441&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tabledata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tabledata` can be installed with:

```
conda install tabledata
```

It is possible to list all of the versions of `tabledata` available on your platform with:
